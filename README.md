...
В ходе тестирования на разных платформах был обнаружен очень неприятный баг с неработающим drag and drop на android(в ходе разработке не было доступа к этой платформе), в планах пофиксить это в ближайшие пару недель.
